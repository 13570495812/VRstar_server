...
package com.jamma.vr_star.otg.util;

import android.hardware.usb.UsbRequest;
import android.util.Log;

import com.jamma.vr_star.otg.driver.UsbSerialPort;
...
public class SerialInputOutputManager implements Runnable {
    ...
    public interface Listener {
        ...
        public void onWriteData(byte[] data,int writeLen);
    ...
    private void step() throws Exception {
        ...
        if (outBuff != null) {
            ...
            int lenWrite=mDriver.write(outBuff, READ_WAIT_MILLIS);
            if(lenWrite>0){
                if (DEBUG) Log.d(TAG, "write data len=" + len);
                if (listener != null) {
                    listener.onWriteData(outBuff,lenWrite);
                }
            }
        }
